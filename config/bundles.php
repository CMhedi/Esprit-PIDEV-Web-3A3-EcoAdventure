...
foreach ($optionalBundles as $bundle => $environments) {
    if (class_exists($bundle)) {
        $bundles[$bundle] = $environments;
    }
}
...
if (class_exists(AhmedBhs\DoctrineDoctor\DoctrineDoctorBundle::class)) {
    $bundles[AhmedBhs\DoctrineDoctor\DoctrineDoctorBundle::class] = ['dev' => true];
}
