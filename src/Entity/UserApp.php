...
class UserApp implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        return RoleUser::tryFrom($this->role) ?? RoleUser::USER_SIMPLE;
    }
    ...
    {
        return $this->specialite ? Specialite::tryFrom($this->specialite) : null;
    }
    ...
    {
        return $this->disponibilite ? Disponibilite::tryFrom($this->disponibilite) : null;
    }
    public function setDisponibilite(?Disponibilite $disponibilite): self
    {
        $this->disponibilite = $disponibilite?->value;
        return $this;
    }
    ...
    public function setGoogleToken(#[\SensitiveParameter] ?string $googleToken): self
    {
    ...
    public function setWeight(float $v): self
    {
        $this->weight = $v;
        return $this;
    }
    ...
    public function setHeight(float $v): self
    {
        $this->height = $v;
        return $this;
    }
    ...
    public function setActivityLevel(float $v): self
    {
    ...
    public function setTelegramToken(#[\SensitiveParameter] ?string $telegramToken): self
    {
