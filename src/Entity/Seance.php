...
if ($this->dateSeance && $this->planning->getDateDebut() && $this->planning->getDateFin()) {
    ...
    $dateSeance = \DateTime::createFromInterface($this->dateSeance)->setTime(0, 0);
    $dateDebut = \DateTime::createFromInterface($this->planning->getDateDebut())->setTime(0, 0);
    $dateFin = \DateTime::createFromInterface($this->planning->getDateFin())->setTime(23, 59, 59);
